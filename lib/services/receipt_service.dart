...
static String _generateQRData(SaleRecord sale) {
    ...
    buffer.writeln('CITY COSMETICS POS');
            ...
            return [
              pw.Header(
                ...
                child: pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [
                    pw.Text('CITY COSMETICS POS', style: pw.TextStyle(font: boldFont)),
        ...
        pw.MultiPage(
          ...
          build: (pw.Context context) {
            return [
              ...
              pw.Center(
                child: pw.Text('Report Generated by City Cosmetics POS', style: pw.TextStyle(font: font, fontSize: 8, color: PdfColors.grey)),
              ),
            ];
          },
        ),
        ...
        pw.MultiPage(
          ...
          build: (pw.Context context) {
            return [
              ...
              pw.SizedBox(height: 40),
              pw.Center(
                child: pw.Text('Verified by City Cosmetics POS', style: pw.TextStyle(font: font, fontSize: 8, color: PdfColors.grey)),
              ),
            ];
          },
        ),
            ...
            return pw.Column(
              ...
              children: [
                pw.Center(
                  child: pw.Column(
                    children: [
                      pw.Text('CITY COSMETICS', style: pw.TextStyle(font: boldFont, fontSize: 16)),
